...
class OrderController extends Controller
{
    ...
    public function getOrderItems($order_code){
        $orderItems=OrderItem::select('order_items.*','products.product_name','products.product_price','products.product_image',)->where('order_code',$order_code)->join('products','products.product_id','order_items.product_id')->get();

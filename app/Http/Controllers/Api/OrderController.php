...
class OrderController extends Controller
{
    ...
    {
        $dbOrderItems = OrderItem::where('order_code', $orderCode)->join('products', 'products.', 'oidrder_items.product_id')->select('order_items.*', 'products.product_name', 'products.product_image', 'products.product_price')->get();

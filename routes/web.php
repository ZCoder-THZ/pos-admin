...
Route::middleware([
    ...
    Route::middleware(['user_auth'])->group(function () {
       Route::group(['prefix'=>'admin'],function(){
        ...
        Route::get('products', [ProductController::class,'home'])->name('product#homePage');
    });
    ...
    Route::post('/category/create',[CategoryController::class,'createCategory'])->name('category#createCategory');
        ...
        Route::get('customerContacts',[ContactController::class,'getContacts'])->name('contact#getContacts');
        Route::get('customer/message/{id}',[ContactController::class,'getMessage'])->name('contact#getMessage');
        Route::get('customer/delete/{id}',[ContactController::class,'deleteMessage'])->name('contact#deleteMessage');
